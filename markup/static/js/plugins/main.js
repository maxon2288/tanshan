...
$(document).ready(function () {
	...
	$(".rev-text__title").click(function () {
		var title = $(this).text();
		var name = $(this).closest(".rev-text__content").find(".rev-text__name").text();
		var desc = $(this).closest(".rev-text__content").find(".rev-text__desc").text();
		console.log(title);
		console.log(name);
		console.log(desc);
		$(".popup-review").find(".popup-rev__title").text(title);
		$(".popup-review").find(".popup-rev__name").text(name);
		$(".popup-review").find(".popup-rev__desc").text(desc);
	});
	...
	if ($(".sidebar").length > 0) {
		$(".open-menu").each(function () {
			...
			var it = $(this);
			var height2 = it.find('.sidebar__sub-menu').innerHeight();
			it.find(".sidebar__sub-menu").css("height", 0);
			if ($(window).width() >= 1023) {
				it.find("span").click(function () {
					if ($(this).hasClass("active")) {
						$(this).closest(".open-menu").find(".sidebar__sub-menu").css("height", 0);
						$(this).closest(".open-menu").find(".sidebar__sub-menu").removeClass("active");
						$(this).removeClass("active");
						if($(".open-menu span").hasClass("active")) {
						...
						$(this).closest(".open-menu").find(this).addClass("active");
						$(this).closest(".open-menu").find(".sidebar__sub-menu").css("height", height2);
						$(this).closest(".open-menu").find(".sidebar__sub-menu").addClass("active");
				...
				it.find("span").click(function () {
					if ($(this).hasClass("active")) {
						$(this).closest(".open-menu").find(".sidebar__sub-menu").css("height", 0);
						$(this).closest(".open-menu").find(".sidebar__sub-menu").removeClass("active");
						$(this).closest(".open-menu").find(".open-menu span.active").removeClass("active");
						if($(".open-menu span").hasClass("active")) {
						...
						$(this).closest(".open-menu").find(".sidebar__sub-menu").addClass("active");
						$(".sidebar").addClass("active");
						$(".sidebar__container").css("min-width", "320px")
